        ...
        <form action="/" onSubmit={SubmitHandler}>
          <div className="mt-[25px]">
            ...
            <div className="flex gap-[20px] mt-[5px]">
              <input
                ...
                className="p-[10px_15px] w-[350px] rounded-md border-[2px] border-gray-500 outline-none"
              />
              <input
                type="text"
                ref={LastNameEle}
          ...
          <div className="flex flex-col mt-[20px]">
            ...
            <input
              ...
              required
              className="p-[10px_15px] w-[720px] rounded-md border-[2px] border-gray-500 outline-none"
            />
          </div>
          <div className="flex gap-[20px] mt-[20px]">
            <div className="flex flex-col">
          ...
          <button className="px-[100px] mt-[30px] py-[10px] bg-green-600 border-2 border-green-600 text-white rounded-xl text-lg hover:bg-white hover:text-green-600 hover:border-2 hover:border-green-600 transition duration-300 ease-in mb-[50px]">
            Save & Place Order
          </button>
        </form>
      )}
