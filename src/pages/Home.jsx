...
function Home(){
  ...
  return (
    <div>
        {
            loading ?
            <div className="min-h-[80vh] flex justify-center items-center"><Spinner></Spinner></div> :
            posts.length>0 ?
            ...
            (<div className="min-h-[80vh] flex justify-center items-center">NO Data Found</div>)
        }
    </div>
  );
}
